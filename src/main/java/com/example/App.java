...
public final class App {
    ...
    public static void apagar() throws SQLException {
        String url = "jdbc:postgresql://aws-0-sa-east-1.pooler.supabase.com:6543/postgres?user=postgres.gydoiuprhwexvnhbjvij&password=senhasupabase";
        String user = "postgres.gydoiuprhwexvnhbjvij";
        String pass = "senhasupabase"; 
